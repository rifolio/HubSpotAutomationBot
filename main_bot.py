...
# Class that handles bots flow
class MyCeliumBot:
    def __init__(self):
        self.bot = telebot.TeleBot(config.TOKEN)
        self.setup_handlers()

    # startup message for user, initial keyboard
    ...
    def send_email(self, message):
        ...
        if access_token_hubspot is None:
            raise ValueError("Access token for HubSpot is not set in the environment variables.")
